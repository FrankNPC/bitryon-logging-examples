...
import io.bitryon.BitryonIntegrationExampleBootApplication;
...
@SpringBootTest(classes = BitryonIntegrationExampleBootApplication.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
